...
public class COTSFalconSwerveConstants {
    ...
    public static class WCP {
        ...
        public static COTSFalconSwerveConstants SwerveXStandard(double driveGearRatio){
        ...
        /* Drive Gear Ratios for all WCP modules */
        public class driveGearRatios{
            /* SwerveX Standard */
            /** Standard - 8.16 : 1 */
            public static final double Standard_6.54 = (8.16 / 1.0);
        }
    }
    ...
    public static class SDS {
        ...
        public static COTSFalconSwerveConstants MK3(double driveGearRatio){
            double wheelDiameter = Units.inchesToMeters(4.0);
        ...
        public static COTSFalconSwerveConstants MK4(double driveGearRatio){
            double wheelDiameter = Units.inchesToMeters(4.0);
        ...
        public static COTSFalconSwerveConstants MK4i(double driveGearRatio){
            double wheelDiameter = Units.inchesToMeters(4.0);
        ...
        /* Drive Gear Ratios for all SDS modules */
        public class driveGearRatios{
            /* SDS MK3 */
            /** SDS MK3 - 8.16 : 1 */
            ...
            /* SDS MK4 */
            /** SDS MK4 - 8.14 : 1 */
            public static final double MK4_L1 = (8.14 / 1.0);
            /** SDS MK4 - 6.75 : 1 */
            public static final double MK4_L2 = (6.75 / 1.0);
            /** SDS MK4 - 6.12 : 1 */
            public static final double MK4_L3 = (6.12 / 1.0);
            /** SDS MK4 - 5.14 : 1 */
            public static final double MK4_L4 = (5.14 / 1.0);
            
            /* SDS MK4i */
            /** SDS MK4i - 8.14 : 1 */
            public static final double MK4i_L1 = (8.14 / 1.0);
            /** SDS MK4i - 6.75 : 1 */
            public static final double MK4i_L2 = (6.75 / 1.0);
            /** SDS MK4i - 6.12 : 1 */
            public static final double MK4i_L3 = (6.12 / 1.0);
        }
    }
}
