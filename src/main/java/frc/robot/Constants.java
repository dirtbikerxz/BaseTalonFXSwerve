...
public final class Constants {
    ...
    public static final class Swerve {
        ...
        public static final class chassisConstants{
            ...
            public static double driveMotorGearRat = (chosenModule.driveGearRatio);
            public static double turnMotorGearRat = (chosenModule.angleGearRatio); 
            public static final double wheelDiameter = Units.inchesToMeters(4);
            public static double circumference = wheelDiameter * Math.PI;
            public static double maxSpeedMPS =  (10 * circumference) / (driveMotorGearRat * 2048);
        ...
        public static final class Mod2 { //TODO: This must be tuned to specific robot
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(135);
            public static final SwerveModuleConstants constants = 
                new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
