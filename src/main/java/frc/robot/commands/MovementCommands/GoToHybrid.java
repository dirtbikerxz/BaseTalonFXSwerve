...
public class GoToHybrid extends SequentialCommandGroup {

  Wrist wrist;
  Elevator elevator;
  /** Creates a new DriveForward. */
  public GoToHybrid(Wrist wrist, Elevator elevator) {
    ...
    addCommands(
        ...
        new ConditionalCommand(
            new SequentialCommandGroup(
                ...
                new SetWristPosition(wrist, Constants.WRIST_CONE_HYBRID_POSITION)
                    .until(() -> wrist.atPosition(Constants.WRIST_CONE_HYBRID_POSITION))
            ),
            ...
            new SequentialCommandGroup(
                ...
                new SetWristPosition(wrist, Constants.WRIST_CUBE_HYBRID_POSITION))
                    .until(() -> wrist.atPosition(Constants.WRIST_CUBE_HYBRID_POSITION)),
