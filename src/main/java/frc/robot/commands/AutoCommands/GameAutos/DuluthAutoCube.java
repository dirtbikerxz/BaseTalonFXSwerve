...
public class DuluthAutoCube extends CommandBase {
    ...
    public DuluthAutoCube(Elevator elevator, Wrist wrist, Intake intake, Swerve swerve) {
    ...
    public void initialize() {
      ...
      PathPlannerTrajectory path = PathPlanner.loadPath("Duluth Auto Cube", new PathConstraints(Constants.AUTO_VEL, Constants.AUTO_ACC));
