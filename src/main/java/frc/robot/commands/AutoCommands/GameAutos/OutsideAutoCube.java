...
public class OutsideAutoCube extends CommandBase {
    ...
    public OutsideAutoCube(Elevator elevator, Wrist wrist, Intake intake, Swerve swerve) {
    ...
    public void initialize() {
        ...
        PathPlannerTrajectory path = PathPlanner.loadPath("Outside Auto Cube", new PathConstraints(Constants.AUTO_VEL, Constants.AUTO_ACC));
