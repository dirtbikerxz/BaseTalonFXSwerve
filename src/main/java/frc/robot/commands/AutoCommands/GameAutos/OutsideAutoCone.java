...
public class OutsideAutoCone extends CommandBase {
    ...
    public OutsideAutoCone(Elevator elevator, Wrist wrist, Intake intake, Swerve swerve) {
    ...
    public void initialize() {
      ...
      PathPlannerTrajectory path = PathPlanner.loadPath("Outside Auto Cone", new PathConstraints(Constants.AUTO_VEL, Constants.AUTO_ACC));
