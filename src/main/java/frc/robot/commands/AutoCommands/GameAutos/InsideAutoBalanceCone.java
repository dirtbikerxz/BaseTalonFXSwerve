...
public class InsideAutoBalanceCone extends CommandBase {
    ...
    public InsideAutoBalanceCone(Elevator elevator, Wrist wrist, Intake intake, Swerve swerve) {
    ...
    public void initialize() {
      ...
      PathPlannerTrajectory path = PathPlanner.loadPath("Inside Auto Balance Cone", new PathConstraints(Constants.AUTO_VEL, Constants.AUTO_ACC));
