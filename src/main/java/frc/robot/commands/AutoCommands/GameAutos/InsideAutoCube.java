...
public class InsideAutoCube extends CommandBase {
    ...
    public InsideAutoCube(Elevator elevator, Wrist wrist, Intake intake, Swerve swerve) {
    ...
    public void initialize() {
      ...
      PathPlannerTrajectory path = PathPlanner.loadPath("Inside Auto Cube", new PathConstraints(Constants.AUTO_VEL, Constants.AUTO_ACC));
