...
public class MidAutoCone extends CommandBase {
    ...
    public MidAutoCone(Elevator elevator, Wrist wrist, Intake intake, Swerve swerve) {
    ...
    public void initialize() {
      ...
      PathPlannerTrajectory path = PathPlanner.loadPath("Mid Auto Cone", new PathConstraints(Constants.AUTO_VEL, Constants.AUTO_ACC));
