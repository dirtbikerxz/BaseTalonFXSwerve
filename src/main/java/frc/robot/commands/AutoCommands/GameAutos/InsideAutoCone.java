...
public class InsideAutoCone extends CommandBase {
    ...
    public InsideAutoCone(Elevator elevator, Wrist wrist, Intake intake, Swerve swerve) {
    ...
    public void initialize() {
        ...
        PathPlannerTrajectory path = PathPlanner.loadPath("Inside Auto Cone", new PathConstraints(Constants.AUTO_VEL, Constants.AUTO_ACC));
