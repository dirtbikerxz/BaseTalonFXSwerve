...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    driver.rightTrigger(.5).onFalse(new RetractIntake( m_acquisition ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));                   
    ...
    driver.rightTrigger(.5).onTrue(new ActivateIntake( m_acquisition ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));                   
